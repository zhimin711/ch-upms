...
public class PositionController {
    ...
    public PageResult<Position> page(Position record, @PathVariable(value = "num") int pageNum,
    ...
    public Result<VueRecord> searchList(@RequestParam(value = "name", required = false) String s) {
        return ResultUtils.wrapList(() -> {
            ...
            LambdaQueryWrapper<Position> query = Wrappers.lambdaQuery(record).eq(Position::getStatus, StatusS.ENABLED)
                    .like(CommonUtils.isNotEmpty(s), Position::getName, s);
