DROP TABLE IF EXISTS `bt_image`;
CREATE TABLE `bt_image` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `NAME` VARCHAR(50) NOT NULL COMMENT '文件名',
  `TYPE` VARCHAR(55) NULL COMMENT '文件后缀:JPG,PNG,GIF',
  `SIZE` BIGINT(20) NULL COMMENT '文件大小',
  `PATH` VARCHAR(255) NOT NULL COMMENT '文件存储相对路径(不包含共享路径)',
  `CATEGORY_TYPE` VARCHAR(255) NULL COMMENT '图片分类',
  `MODE` VARCHAR(10) DEFAULT NULL COMMENT '类型(1.公共 2.用户 3.文章 4.图标 5.背景)',
